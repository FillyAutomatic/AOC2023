...
public class G1 {
    public static void main(String[] args) throws IOException {
        ...
        Arrays.sort(hands, (String a, String b) -> {
            a = a.replaceAll("T", "a").replaceAll("J", "b").replaceAll("Q", "c").replaceAll("K", "d").replaceAll("A",
                    "e");
            b = b.replaceAll("T", "a").replaceAll("J", "b").replaceAll("Q", "c").replaceAll("K", "d").replaceAll("A",
                    "e");
